...
<head>
	...
	<title>Investodea - Investor Profile</title>
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<select name="state" required class="selectpicker show-tick form-control" data-live-search="true">
                                                           ...
                                                           {
		                                                    ?> <option <?php if ($mystate == $row['state_name']) { print ' selected '; } ?> value="<?php echo $row['state_name']; ?>"><?php echo $row['state_name']; ?></option> <?php
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<input type="text" name="phone" required class="form-control" placeholder="Mobile number" pattern="[6789][0-9]{9}" value="<?php echo "$myphone"; ?>">
													</div>
