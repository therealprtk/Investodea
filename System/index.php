...
<body class="home">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/back.jpg');"> <!-- Background-->
				<div class="container">

					<h1><b>Investodea</b></h1>
					<p>Make Your Ideas Happen!     Find Your Super Ideas here.</p>
<!--Search box-->
	...
	<!--Steps end-->						 
			...
			<div class="pt-0 pb-50">
				...
				<div class="container">
					...
					<a target="_blank" href="company.php?ref=<?php echo $row['member_no']; ?>">View Profile</a>
					</div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-12">
                            ...
                            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                            $stmt = $conn->prepare("SELECT * FROM ideas ORDER BY enc_id DESC LIMIT 8");
                            $stmt->execute();
                            $result = $stmt->fetchAll();
