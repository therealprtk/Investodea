...
<head>
	...
	<title>Investodea - Investors</title>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title"><b>Investors</b></h3>
						</div>
						...
						<div class="GridLex-gap-15-wrappper">
									...
									<div class="employee-grid-item">
										...
										<div class="action">
											...
											<div class="content">
												...
												<p class="location"><i class="fa fa-map-marker"></i> <?php echo $row['state'] ?></p>
                            ...
                            $total_records++;
	                        ...
	                        }catch(PDOException $e)
                             {
								...
								print '<li class="paging-nav" '; if ($page == "1") { print 'class="disabled"'; } print '><a '; if ($page == "1") { print ''; } else { print 'href="investors.php?page='.$prevpage.'"';} print '><i class="fa fa-chevron-left"></i></a></li>';
					            for ($b=1;$b<=$records;$b++)
                                 {
                                 
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>  href="investors.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
								 print '<li class="paging-nav"'; if ($page == $records) { print 'class="disabled"'; } print '><a '; if ($page == $records) { print ''; } else { print 'href="investors.php?page='.$nextpage.'"';} print '><i class="fa fa-chevron-right"></i></a></li>';
					             }
