										...
										<form class="post-form-wrapper" action="app/update-job.php" method="POST" autocomplete="off">
											...
											<?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														<label>state</label>
														<select name="state" required class="selectpicker show-tick form-control" data-live-search="true">
                                                           ...
                                                           foreach($result as $row)
                                                           {
		                                                    ?> <option <?php if ($jobstate == $row['state_name']) { print ' selected '; } ?> value="<?php echo $row['state_name']; ?>"><?php echo $row['state_name']; ?></option> <?php
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="jobtype" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option <?php if ($jobtype == "Long Term Investment") { print ' selected '; } ?> value="Long Term Investment" data-content="<span class='label label-warning'>Long Term Investment</span>">Long Term Investment</option>
															<option <?php if ($jobtype == "Short Term Investment") { print ' selected '; } ?> value="Short Term Investment" data-content="<span class='label label-danger'>Short Term Investment</span>">Short Term Investment</option>
															<option <?php if ($jobtype == "Mini Investment") { print ' selected '; } ?> value="Mini Investment" data-content="<span class='label label-success'>Mini Investment</span>">Mini Investment</option>
														</select>
													</div>
