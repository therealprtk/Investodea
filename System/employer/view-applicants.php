...
<head>
	...
	<title>Investodea - Applicants </title>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Applicants for <?php echo "$job_title"; ?></</h3>
						</div>
									...
									<div class="employee-grid-item">
										...
										<div class="action">
											...
											<div class="content">
												...
												<a href="tel:+91<?php echo $rowb['phone'] ?>"><p class="phone"><i class="fa fa-phone"></i> Call Now</p></a>
