										...
										<form class="post-form-wrapper" action="app/post-job.php" method="POST" autocomplete="off">
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														...
														<select name="state" required class="selectpicker show-tick form-control" data-live-search="true">
                                                           ...
                                                           {
		                                                    ?> <option <?php if ($state == $row['state_name']) { print ' selected '; } ?> value="<?php echo $row['state_name']; ?>"><?php echo $row['state_name']; ?></option> <?php
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="jobtype" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option value="Long Term Investment" data-content="<span class='label label-warning'>Long Term Investment</span>">Long-time</option>
															<option value="Short Term Investment" data-content="<span class='label label-danger'>Short Term Investment</span>">Short-time</option>
															<option value="Mini Investment" data-content="<span class='label label-success'>Mini Investment</span>">Mini</option>
														</select>
													</div>
												...
												<div class="col-sm-6 mt-30">
													<button type="submit"  onclick = "validate(this)" class="btn btn-primary btn-lg">Post Your Idea</button>
												</div>
