...
try {
	...
	$sta = '<span class="label label-success">Mini Investment</span>';
											  
	}
	if ($jobtype == "Short Term Investment") {
	$sta = '<span class="label label-danger">Short Term Investment</span>';
											  
	}
	if ($jobtype == "Long Term Investment") {
	$sta = '<span class="label label-warning">Long Term Investment</span>';
...
<head>
	...
	<title>Investodea - <?php echo "$jobtitle"; ?></title>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/inv.png" alt="Logo" /></a>    <!--logo-->
						</div>
					</div>
							...
							<div class="job-detail-wrapper">
								...
								<div class="job-detail-header text-center">
									...
									<div class="meta-div clearfix mb-25">
										<span>by <a target="_blank" href="company.php?ref=<?php echo "$compid"; ?>"><?php echo "$compname"; ?></a> as </span>
										<?php echo "$sta"; ?>
									</div>
						        ...
						        if ($user_online == true) {
								if ($jobexpired == true) {
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-calendar"></i> Expired</button>';
								}else{
								if ($myrole == "employee") {
                                print '<button';?> onclick="update(this.value)" <?php print ' value="'.$jobid.'" class="btn btn-primary btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-pencil"></i>Want to Invest</button>';
								}else{
								...
								<div class="tab-style-01">
									...
									<ul class="nav" role="tablist">
										<li role="presentation" class="active"><h4><a href="#relatedJob1" role="tab" data-toggle="tab">More Ideas by <?php echo "$compname"; ?></a></h4></li>
									</ul>
														...
														<div class="GridLex-grid-middle">
															...
															<div class="GridLex-col-3_sm-8-xs-8_xss-12 mt-10-xss">
																<div class="job-location">
																	<i class="fa fa-map-marker text-primary"></i> <?php echo $row['state']; ?>
																</div>
															</div>
