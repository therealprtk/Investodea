...
<head>
	...
	<title>Investodea - <?php echo "$compname"; ?></title>
					...
					<div class="row">
							...
							<div class="col-md-10 col-md-offset-1">
								...
								<div class="company-detail-wrapper">
                                    ...
                                    $stmt = $conn->prepare("SELECT * FROM ideas WHERE company = :compid ORDER BY enc_id DESC LIMIT 5");
										 ...
										 ?>
											...
											<div class="content">
												...
												<div class="job-item-list-bottom">
													...
													<div class="col-sm-5 col-md-4">
														<a target="_blank" href="explore-job.php?jobid=<?php echo $row['idea_id']; ?>" class="btn btn-primary">View This Idea</a>
													</div>
                                ...
                                $stmt = $conn->prepare("SELECT * FROM ideas WHERE company = :compid ORDER BY enc_id DESC");
                                $stmt->bindParam(':compid', $company_id);
                                $stmt->execute();
                                $result = $stmt->fetchAll();
